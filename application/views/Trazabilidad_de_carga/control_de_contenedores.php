...
<head>
  ...
  <meta property="og:site_name" content="Control de Contenedores">
  <meta property="og:url" content="<?php echo base_url(); ?>Trazabilidad_de_Carga/contenedores">
  <meta property="og:title" content="Control de Contenedores">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/trazabilidad/contenedor/control-de-contenedores-1.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h2>CONTROL DE CONTENEDORES</h2>
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>EFICIENCIA EN LOGÍSTICA PORTUARIA</strong>
              </h3>
              <p style="text-align: center;">La utilización de tecnología de identificación por radio frecuencia permite optimizar procesos, automatizando todos los movimientos de los contenedores dentro del puerto reduciendo errores y tiempo de gestión.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Elevados tiempos y costos de gestión.</p>
                  <p>Robos de contenedores.</p>
                  <p>Procesos lentos.</p>

                </div>
                <div class="tab-pane" style="display: none;">
                  <p>El contenedor se carga y se relaciona con el precinto RFID, se inspeccionar, se cierra y se relaciona con el TAG RFID.</p>
                  <p>Al ingresar se captura el código de contenedor, del vehículo y del TAG RFID.</p>
                  <p>Al pasar los puntos de control, los lectores envian la información de los contenedores al sistema.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Reducción de errores humanos.</p>
                  <p>Información precisa en menor tiempo.</p>
                  <p>Mayor seguridad en la carga.</p>
                  <p>Mejora en utilización de los recursos.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/trazabilidad/contenedor/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. RELACIONA</h2>
                  <div class="member-pos theme_color">el contenedor con el tag RFID.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/trazabilidad/contenedor/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. INFORMACIÓN</h2>
                  <div class="member-pos theme_color">a precisa en menjor tiempo.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/trazabilidad/contenedor/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. REDUCCIÓN</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/trazabilidad/contenedor/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. ALERTA</h2>
                  <div class="member-pos theme_color">de apertura del contenedor.</div>
                </div>
              </div>
            </div>
          </div>
