  ...
  <body>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          ...
          <img src="<?php echo base_url(); ?>/application/helpers/images/trazabilidad/contenedor/control-de-contenedores-1.jpg" alt="...">
          <div class="carousel-caption banner_res_2" id="hide1" style="display:none;">
            <span class="top">CONTROL DE </span><span class="text_red top">CONTENEDORES</span><br>
    ...
    <div class="bloque" id="soluciones">
      <div class="row titulo">
        <div class="col-md-12">
          <span class="">EFICIENCIA EN LOGÍSTICA PORTUARIA</span>
        </div>
      </div>
      <div class="row detalle">
        <div class="col-md-12">
          <span>La utilización de tecnología de identificación por radio frecuencia permite</span><br>
          <span>optimizar procesos, automatizando todos los movimientos de los contenedores</span><br>
          <span>dentro del puerto reduciendo errores y tiempo de gestión.</span>
        </div>
      </div>
    </div>
    <div class="cuerpodetalle" id="bloques" >
      <div class="row ">
        <div class="col-md-4 black center" id="a" style="min-height: 510px;display:none;">
          <div class="">
          ...
          <div class="row">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Elevados tiempos y costos de gestión.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Robos de contenedores.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Procesos lentos.</span>
            </div>
          </div>
        </div>
        <div class="col-md-4 red center" id="b" style="min-height: 510px;display:none;">
          <div class="">
          ...
          <div class="row">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">El contenedor se carga y se relaciona con el precinto RFID, se inspeccionar, se cierra y se relaciona con el TAG RFID.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Al ingresar se captura el código de contenedor, del vehículo y del TAG RFID.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Al pasar los puntos de control, los lectores envian la información de los contenedores al sistema.</span>
            </div>
          </div>
        </div>
        <div class="col-md-4 black center"  id="c" style="min-height: 510px;display:none;">
          <div class="">
          ...
          <div class="row">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Información precisa en menor tiempo.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Mayor seguridad en la carga.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Mejora en utilización de los recursos.</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="fichero">
      <img class="fondotop" src="<?php echo base_url(); ?>/application/helpers/images/trazabilidad/contenedor/superior.png" alt="" id="top" style="opacity:0">
      <img class="fondobot" align="right" src="<?php echo base_url(); ?>/application/helpers/images/trazabilidad/contenedor/inferior.png" alt="" id="bot" style="opacity:0">
      ...
      <div class="cuarto" id="num_4" style="display:none">
        <div class="row" style="margin-left: 20%;">
          <img class="imagen" src="<?php echo base_url(); ?>/application/helpers/iconos/trazabilidad/iconoalerta.png" alt="">
        </div>
        <div class="row text_red_bold">
          <div class="col-xs-1 col-sm-1 col-md-1">
            4.
          ...
          <div class="col-md-9">
            ALERTA
            <span style="color:#333; font-weight:normal;font-size:14px;"> de </span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
