  ...
  <body>
    ...
    <div class="bloque" id="soluciones">
      <div class="row titulo">
        <div class="col-md-12">
          <span class="">ADMINISTRACION DE ACTIVOS DE FORMA EFICIENTE</span>
        </div>
      </div>
      <div class="row detalle">
        <div class="col-md-12">
          <span>El control de activos retornables basado en tecnología (RFID), es la forma mas</span><br>
          <span>efectiva de monitorear el movimiento  de las mismas dentro de la cadena de</span><br>
          <span>abastecimiento logístico que son utilizados.</span>
        </div>
      </div>
    </div>
    ...
    <div class="fichero">
      <img class="fondotop" src="<?php echo base_url(); ?>/application/helpers/images/control/retornable/cuerpo-1.png" alt="" id="top" style="opacity:0">
      <img class="fondobot" align="right" src="<?php echo base_url(); ?>/application/helpers/images/control/retornable/cuerpo-2.png" alt="" id="bot" style="opacity:0">
