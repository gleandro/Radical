        ...
        <div class="container">
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <p style="text-align: center;">El control de activos retornables basado en tecnología (RFID), es la forma mas efectiva de monitorear el movimiento de las mismas dentro de la cadena de abastecimiento logístico que son utilizados.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  ...
                  <p>Mala visivilidad del stock.</p>
                  <p>Problemas operativos por falta de herramientas de control de stock.</p>

                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Se identifica cada contenedor con un tipo de Tag RFID de acuerdo al material necesario.</p>
