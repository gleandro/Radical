...
<head>
  ...
  <title>Control de Neumaticos</title>
  <link rel="dns-prefetch" href="//s.w.org">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
  <meta property="og:site_name" content="Control de Neumaticos">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_Activos/neumaticos">
  <meta property="og:title" content="Control de Neumaticos">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="background-position: right;margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/control/neumaticos/CONTROL-DE-NEUMATICOS-HEADER.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h2>CONTROL DE NEUMÁTICOS</h2>
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>OPTIMICE SUS NEUMÁTICOS</strong>
              </h3>
              <p style="text-align: center;">Nuestra solución utiliza identificadores RFID aplicados en la parte interior del neumático reduciendo tiempos, recursos y errores involucrados en la gestión de los mismos.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Robos y pérdidas de neumáticos.</p>
                  <p>Desconocimiento de tiempo de vida de los neumáticos.</p>
                  <p>Desperdicio de recursos designados a la gestión de los neumáticos.</p>

                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Identificar cada neumático con un tag RFID.</p>
                  <p>Asociar cada neumático con su vehículo correspondiente.</p>
                  <p>El sistema conocerá qué neumático utiliza cada auto para una posterior auditoría.</p>
                  <p>Inspeccionar los kilómetros recorridos, la presión del aire y la profundidad de la huella, utilizando el terminar portátil.</p>
                </div>
                <div class="tab-pane" style="display: none;">
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/neumaticos/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. DIAGNOSTICO PRECISO</h2>
                  <div class="member-pos theme_color">y seguro.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/neumaticos/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/neumaticos/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. REDUCE</h2>
                  <div class="member-pos theme_color">el riesgo de perdidas.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/neumaticos/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. OPTIMIZA</h2>
                  <div class="member-pos theme_color">el ciclo de vida de la llanta.</div>
                </div>
              </div>
            </div>
          </div>
