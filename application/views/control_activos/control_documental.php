...
<head>
  ...
  <meta property="og:site_name" content="Control Documental">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_Activos/documental">
  <meta property="og:title" content="Control Documental">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/control/documental/control-de-documentos-header.jpg);">
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>ADMINISTRACIÓN DE ARCHIVOS DE FORMA EFICIENTE</strong>
              </h3>
              <p style="text-align: center;">Con la tecnología RFID los documentos obtienen una identidad digital dando al personal la posibilidad de efectuar tareas de búsqueda y localización con solo un click.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Confusión y pérdida de documentos por error humano.</p>
                  <p>Tiempo perdido en búsqueda de documentos.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Identificación de documento con tag RFID.</p>
                  <p>Se agrupa en carpetas y cajas. Se registran y relacionan las mismas.</p>
                  <p>Permite administrar de manera eficiente todos los archivos.</p>
                  <p>Se aplica en: Organismos gubernamentales; Tribunales y estudios jurídicos;Organizaciones Financieras; Centros Hospitalarios;Bibliotecas y Depósitos empresariales.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Eliminar el extravío de archivos.</p>
                  <p>Genera de manera automática informes.</p>
                  <p>Ubicar archivos o expedientes de manera rápida y eficiente.</p>
                  <p>Incrementa la productividad del personal.</p>
                  <p>Seguimiento a préstamo de documentos.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/documental/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. RAPIDA</h2>
                  <div class="member-pos theme_color">identificación de cada documento.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/documental/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/documental/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. REDUCE</h2>
                  <div class="member-pos theme_color">la pérdida de documentos.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/documental/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. SEGUIMIENTO</h2>
                  <div class="member-pos theme_color">total a los documentos con el tag RFID.</div>
                </div>
              </div>
            </div>
          </div>
