...
<html>
  ...
  <body>
    ...
    <div class="fichero">
      <img class="fondotop" src="<?php echo base_url(); ?>/application/helpers/images/control/documental/CONTROL-DE-DOCUMENTOS-SUPERIOR.png" alt="" id="top" style="opacity:0">
      <img class="fondobot" align="right" src="<?php echo base_url(); ?>/application/helpers/images/control/documental/CONTROL-DE-DOCUMENTOS-INFERIOR.png" alt="" id="bot" style="opacity:0">
