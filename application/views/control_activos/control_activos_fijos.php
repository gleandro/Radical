  ...
  <body>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          ...
          <img src="<?php echo base_url(); ?>/application/helpers/images/control/activos/control-de-activosFIJOS-page.jpg" alt="...">
          <div class="carousel-caption banner_res_2" id="hide1" style="display:none;">
            <span class="top">CONTROL DE </span><span class="text_red top">ACTIVOS FIJOS</span><br>
    ...
    <div class="bloque" id="soluciones">
      ...
      <div class="row detalle">
        <div class="col-md-12">
          <span>La utilización de tecnología RFID nos permite realizar el procedimiento de captura</span><br>
          <span>de los activos, de una forma mas rápida y ágil, identificando y auditando los</span><br>
          <span>mismos en cuestión de minutos.</span>
        </div>
      </div>
    </div>
    <div class="cuerpodetalle" id="bloques" >
      <div class="row ">
        <div class="col-sm-12 col-md-12 col-lg-4 black center" id="a" style="display:none;">
          <div class="">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 red center" id="b" style="display:none;">
          <div class="">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 black center" id="c" style="display:none;">
          <div class="">
    ...
    <div class="fichero">
      <img class="fondotop" src="<?php echo base_url(); ?>/application/helpers/images/control/activos/control-de-activos-IMAGEN-SUPERIOR-CUERPO.png" alt="" id="top" style="opacity:0">
      <img class="fondobot" align="right" src="<?php echo base_url(); ?>/application/helpers/images/control/activos/control-de-activos-IMAGEN-INFERIOR-CUERPO.png" alt="" id="bot" style="opacity:0">
      <div class="primero" id="num_1" style="display:none">
        <div class="row text_red_bold">
          ...
          <div class="col-md-10">
            ASOCIA
            <span style="color:#333; font-weight:normal;font-size:14px;"> el activo </span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
      ...
      <div class="cuarto" id="num_4" style="display:none">
        <div class="row" style="margin-left: 20%;">
          <img class="imagen" src="<?php echo base_url(); ?>/application/helpers/iconos/control_activos/3.png" alt="">
        </div>
        <div class="row text_red_bold">
          <div class="col-xs-1 col-sm-1 col-md-1">
            4.
