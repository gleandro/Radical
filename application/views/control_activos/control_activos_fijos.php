...
<head>
  ...
  <meta property="og:site_name" content="Control de Activos Fijos">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_Activos/activos">
  <meta property="og:title" content="Control de Activos Fijos">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style=" background-position: 22%;margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/control/activos/control-de-activosFIJOS-page.jpg);">
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>OPTIMICE LOS ACTIVOS FIJOS DE SU EMPRESA</strong>
              </h3>
              <p style="text-align: center;">La utilización de tecnología RFID nos permite realizar el procedimiento de captura de los activos, de una forma mas rápida y ágil, identificando y auditando los mismos en cuestión de minutos.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Sistema manual de stock muy lento.</p>
                  <p>La precisión de la información depende de la habilidad humana.</p>
                  <p>Auditoria de inventarios con alto costo.</p>

                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Asociar la información del activo con un código de identificación.</p>
                  <p>Lectura simultanea de todos de los activos existentes.</p>
                  <p>Transmisión de la información y reporte de diferencias.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Auditorias de activos más rápidas.</p>
                  <p>Economizar tiempo y dinero en auditorias.</p>
                  <p>Fácil lectura de gran cantidad de activos.</p>
                  <p>Mejor visibilidad de los activos y su ubicación.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/activos/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. ASOCIA</h2>
                  <div class="member-pos theme_color">el activo con su codigo.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/activos/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/activos/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. TRANSMITE</h2>
                  <div class="member-pos theme_color">información y reportes.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/control/activos/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. ECONOMIZA</h2>
                  <div class="member-pos theme_color">tiempo y dinero en auditorias.</div>
                </div>
              </div>
            </div>
          </div>
