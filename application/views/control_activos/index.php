  ...
  <body>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          ...
          <div class="carousel-caption banner_res_2" id="hide2" style="display:none;">
    ...
    <div class="cuerpo" style="min-height:200px;" >
      ...
      <div class="linea row" style="display:inline;">
        <div class="col-sm-6 col-sm-4 col-lg-4" id="hide3" style="display:none">
        ...
        <div class="col-sm-6 col-sm-4 col-lg-4" id="hide4" style="display:none">
        ...
        <div class="col-sm-6 col-sm-4 col-lg-4" id="hide5" style="display:none">
        ...
        <div class="col-sm-6 col-sm-4 col-lg-4" id="hide6" style="display:none">
        ...
        <div class="col-sm-6 col-sm-4 col-lg-4" id="hide7" style="display:none">
