...
<head>
  ...
  <meta property="og:site_name" content="Control de Eventos">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_de_Eventos">
  <meta property="og:title" content="Control de Eventos">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/eventos/header.jpg);">
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>CONTROL DE EVENTOS RFID UHF</strong>
              </h3>
              <p style="text-align: center;">RFID UHF son la solución perfecta para gestionar el control de los eventos quien se podrá controlar quién entra en ferias y conciertos, así como gestionar la zona VIP con aplicaciones de valor almacenado RFID.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>No se posee un control total ni a tiempo real por lo que genera entradas y salidas no deseadas.</p>
                  <p>Falta de supervisión exacta en las entradas debido a la cantidad de personas y no es posible monitorear durante mucho tiempo.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Implementación de un control de eventos con RFID UHF para el correcto seguimiento.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Control absoluto del usuario con el control de eventos.</p>
                  <p>Supervisión y fácil manejo en el total del ingreso a distintas zonas.</p>
                  <p>Conozca la cantidad de personas que tiene el evento.</p>
                  <p>Conceda o deniegue sin necesidad de listas.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/eventos/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. OTORGAR</h2>
                  <div class="member-pos theme_color">los bracaletes RFID a los usuarios.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/eventos/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/eventos/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. CONOZCA</h2>
                  <div class="member-pos theme_color">la identidad de usuarios en el evento.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/eventos/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. EVITE</h2>
                  <div class="member-pos theme_color">entradas indebidas otorgando entrada a distintas zonas solo a usuarios autorizados.</div>
                </div>
              </div>
            </div>
          </div>
