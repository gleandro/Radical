  ...
  <body>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          ...
          <img src="<?php echo base_url(); ?>/application/helpers/images/eventos/header.jpg" alt="...">
          <div class="carousel-caption banner_res_2" id="hide1" style="display:none;">
            <span class="top">CONTROL DE </span><span class="text_red top">EVENTOS</span><br>
            <span class="back">RFID UHF</span><br>
          </div>
        </div>
      </div>
    </div>
    <div class="bloque" id="soluciones">
      <div class="row titulo">
        <div class="col-md-12">
          <span class="">CONTROL DE EVENTOS RFID UHF</span>
        </div>
      </div>
      <div class="row detalle">
        <div class="col-md-12">
          <span>RFID UHF son la solución perfecta para gestionar el control de los eventos quien se</span><br>
          <span>podrá controlar quién entra en ferias y conciertos, así como gestionar la zona VIP</span><br>
          <span>con aplicaciones de valor almacenado RFID.</span><br>
        </div>
      </div>
    </div>
      ...
      <div class="row ">
        <div class="col-md-4 black center" id="a" style="display:none;">
          ...
          <div class="row">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">No se posee un control total ni a tiempo real por lo que genera entradas y salidas no deseadas.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Falta de supervisión exacta en las entradas debido a la cantidad de personas y no es posible monitorear durante mucho tiempo.</span>
            </div>
          </div>
        </div>
        <div class="col-md-4 red center" id="b" style="display:none;">
          ...
          <div class="row">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Implementación de un control de eventos con  RFID UHF para el correcto seguimiento.</span>
            </div>
          </div>
        </div>
        <div class="col-md-4 black center" id="c" style="display:none;">
          ...
          <div class="row">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Control absoluto del usuario con el control de eventos.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Supervisión y fácil manejo en el total del ingreso a distintas zonas. </span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Conozca la cantidad de personas que tiene el evento.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Conceda o deniegue sin necesidad de listas.</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="fichero">
      <img class="fondotop" src="<?php echo base_url(); ?>/application/helpers/images/eventos/superior.png" alt="" id="top" style="opacity:0">
      <img class="fondobot" align="right" src="<?php echo base_url(); ?>/application/helpers/images/eventos/inferior.png" alt="" id="bot" style="opacity:0">
      <div class="primero" id="num_1" style="display:none">
        <div class="row text_red_bold">
          ...
          <div class="col-md-9" >
            OTORGAR
            <span style="color:#333; font-weight:normal;font-size:14px;"> los</span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
          ...
          <div class="col-md-9">
            bracaletes RFID a los usuarios.
          </div>
        </div>
      </div>
      ...
      <div class="tercero" id="num_3" style="left: 52%;display:none">
        <div class="row text_red_bold">
          ...
          <div class="col-md-9" >
            CONOZCA
            <span style="color:#333; font-weight:normal;font-size:14px;">la identidad</span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
      ...
      <div class="cuarto" id="num_4" style="top: 65%;left: 65%;display:none">
        ...
        <div class="row text_red_bold">
          ...
          <div class="col-md-9" >
            EVITE
            <span style="color:#333; font-weight:normal;font-size:14px;"> entradas</span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
          ...
          <div class="col-md-9">
            indebidas otorgando entrada a distintas zonas solo a usuarios autorizados.
          </div>
        </div>
      </div>
      <div class="quinto" id="num_5" style="display:none">
        <img style="width: 35%;" class="imagen" src="<?php echo base_url(); ?>/application/helpers/iconos/control_activos/2.png" alt="">
      </div>
    </div>
