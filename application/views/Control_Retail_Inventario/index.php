        ...
        <div class="container">
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <p style="text-align: center;">Nuestra solución comprende un sistema de Identificación y captura de datos con tecnología RFID diseñado para capturar información de forma automática, rápida y libre de errores, realizando la lectura de múltiples items en forma simultanea.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" style="display: none;">
                  ...
                  <p>Se controla el despacho utilizando un tunel RFID.</p>
                </div>
                <div class="tab-pane" style="display: none;">
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              ...
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. CONTROLA</h2>
                  <div class="member-pos theme_color">el despacho con tunel RFID.</div>
                </div>
              </div>
            </div>
          </div>
