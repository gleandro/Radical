...
<head>
  ...
  <meta property="og:url" content="<?php echo base_url(); ?>Radical/Contacto">
  ...
  <script type="text/javascript" src="http://macphoto.evatheme.com/demo/wp-includes/js/jquery/jquery.js?ver=1.12.4">
  </script>
  <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Dosis:200,300,400,500,600,700,800">
</head>
<body class="page-template-default page page-id-9 pagetitle_show portfolio_slider_ footer_show">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_show text-left" style="margin-top: -122px;">
      <div class="pagetitle_content" style="background-position: 65% top;background-image: url(<?php echo base_url(); ?>/application/helpers/images/CONTACTO.jpg);">
        <div class="pagetitle_content_wrap clearfix">
          <h2>Contactanos</h2>
          <span class="pagetitle_line" style="left: 361px; right: 232px;"></span>
        </div>
      </div>
    </div>
    <div id="page-content" style="min-height: 146px;">
      <div id="default_page" class="no_sidebar">
        <div class="container">
          <div class="row">
            <div class="col-md-12 ">
              <div class="contentarea clearfix">
                <div class="row-container  bg-scroll boxed" style="">
                  <div class="container">
                    <div class="row" style=" padding-right: 185px; padding-left: 185px;">
                      <div class="col-md-12 ">
                        <div class="row">
                          <div class="cs-element  col-md-8" style="margin-bottom:60px;">
                            <h3 style="line-height: 50px; font-size: 34px;">
                              <p>Dirección:</p>
                              <p>Calle German Schreiber 276 San Isidro - Lima - Perú</p>
                            </h3>
                          </div>
                          <div class="cs-element  col-md-4" style="margin-bottom:60px;">
                            <h4 style="margin-bottom: 0; line-height: 50px; font-size: 26px; color: rgba(255,255,255,0.5);">
                              <a href="tel:4697684">+51 - 4697684</a>
                            </h4>
                            <h4 style="margin-bottom: 0; line-height: 50px; font-size: 26px; color: #535458;">
                              <a href="mailto:info@rfidperu.pe">info@rfidperu.pe</a>
                            </h4>
