...
<head>
  ...
  <meta property="og:url" content="<?php echo base_url(); ?>Radical/nosotros">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
        ...
        <div class="header_right_part text-right">
          <div class="menu-primary-menu-container-wrap">
            <ul id="menu-primary-menu" class="nav-menu clearfix">
              <li id="menu-item-3718" class="menu-item menu-item-type-custom menu-item-object-custom menu-item menu-item-3717">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style=" background-position: 43.5%;margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/carousel/home.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h3>NUESTRA COMPAÑIA TIENE LA SOLUCIÓN A TUS PROBLEMAS</h3>
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>SOLUCIONES RÁPIDAS  RFID</strong>
              </h3>
              <p style="text-align: center;">Nuestra compañia ha adoptado un enfoque de construcción modular de soluciones con las revoluciones tecnológicas wireless WSN y RFID, que entregan al cliente lo que exactamente necesita, con un completo portafolio de soluciones de comunicaciones inalámbricas M2M.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <p style="text-align: center;">Somos un equipo de profesionales altamente calificados, creativos, y comprometidos con el desarrollo de soluciones innovadoras. Nuestro equipo de investigación (R&D) ha desarrollado cerca de 18 proyectos en los últimos 3 años y actualmente venimos trabajando para implementar nuestras tecnologías en seguridad pubolica, seguridad nacional y con un completo portafolio de soluciones de comunicaciones inalámbricas M2M.</p>
              <p style="text-align: center;">&nbsp;</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
