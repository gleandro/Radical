...
<head>
  ...
  <title>Trazabilidad de Medicamentos</title>
  <link rel="dns-prefetch" href="//s.w.org">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
  <meta property="og:site_name" content="Trazabilidad de Medicamentos">
  <meta property="og:url" content="<?php echo base_url(); ?>Salud_y_Trazabilidad/medicamentos">
  <meta property="og:title" content="Trazabilidad de Medicamentos">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/salud/salud-y-trazabilidad.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h2>TRAZABILIDAD DE MEDICAMENTOS</h2>
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>TRAZABILIDAD DE MEDICAMENTOS Y PRODUCTOS MÉDICOS</strong>
              </h3>
              <p style="text-align: center;">Nuestra solución comprende un sistema de identificación y captura de datos con tecnología RFID diseñado para capturar información de forma automática y a alta velocidad, realizando la lectura de todos los items de forma simultánea.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Pérdida o robo de medicamentos controlados.</p>
                  <p>Pérdida de tiempo en búsqueda de medicamentos.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Las etiquetas RFID permitirán identificar y controlar los medicamentos de forma automática y rápida.</p>
                  <p>La etiqueta es inviolable hasta el momento de su uso de manera que asegura la trazabilidad hasta entregar al consumidor.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Identificación unívoca de cada medicamento.</p>
                  <p>Control de todos los procesos involucrados en la cadena de abastecimiento.</p>
                  <p>Reducción de tiempos y costos de control.</p>
                  <p>Reducción de falsificaciones.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/salud/medicamentos/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. ASOCIAR</h2>
                  <div class="member-pos theme_color">tags rfid a los medicamentos.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/salud/medicamentos/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/salud/medicamentos/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. CONTROL</h2>
                  <div class="member-pos theme_color">de inventario en farmacia.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/salud/medicamentos/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. REDUCE</h2>
                  <div class="member-pos theme_color">costos de control y falsificaciones.</div>
                </div>
              </div>
            </div>
          </div>
