...
<head>
  ...
  <meta property="og:site_name" content="Seguimiento de Pacientes">
  <meta property="og:url" content="<?php echo base_url(); ?>Salud_y_Trazabilidad/seguimiento">
  <meta property="og:title" content="Seguimiento de Pacientes">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/salud/pacientes/pacientes.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h2>SEGUIMIENTO DE PACIENTES Y PERSONAL MÉDICO</h2>
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>TRAZABILIDAD DE PACIENTES Y PERSONAL MEDICO</strong>
              </h3>
              <p style="text-align: center;">Nuestra solución comprende un sistema de Identificación y captura de datos con tecnología RFID para el monitoreo de los pacientes y personal médico, logrando una eficiente atención en los servicios de salud y alcanzar la certificación de servicios de salud de clase mundial.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Mala localización de pacientes y personal.</p>
                  <p>Falta de control en la distribución en la dosis de medicamentos.</p>
                  <p>Elimina el riesgo de cambio de recién nacidos por confusión o error humano.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Cada paciente debe ser identificado con etiquetas RFID las cuales identificarán y controlarán la ubicación del paciente y la dosis de medicamentos.</p>
                  <p>Se garantiza la trazabilidad dentro de todo el proceso (envíos, recepción y exportación) controlando cada eslabón de la cadena de atención.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Identificación rápida de pacientes.</p>
                  <p>Emite alarma si el paciente y/o personal cruza el perímetro permitido.</p>
                  <p>Reducción de tiempos y costos de control en la entrega de dosis a pacientes.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/salud/pacientes/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. ASOCIA</h2>
                  <div class="member-pos theme_color">cada paciente con etiquetas RFID.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/salud/pacientes/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/salud/pacientes/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. REDUCE</h2>
                  <div class="member-pos theme_color">tiempo y costos en el seguimiento de pacientes.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/salud/pacientes/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. ADMINISTRA</h2>
                  <div class="member-pos theme_color">de manera eficaz en el dosaje de medicamentos.</div>
                </div>
              </div>
            </div>
          </div>
