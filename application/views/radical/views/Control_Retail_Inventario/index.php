...
<head>
  ...
  <title>Control de Retail e Inventario</title>
  <link rel="dns-prefetch" href="//s.w.org">
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
  <meta property="og:site_name" content="Control de Retail e Inventario">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_Retail_Inventario">
  <meta property="og:title" content="Control de Retail e Inventario">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/carousel/img4.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h2>CONTROL DE RETAIL E INVENTARIO</h2>
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>MAYOR AHORRO DE TIEMPO Y DINERO</strong>
              </h3>
              <p style="text-align: center;">Nuestra solución comprende un sistema de Identificación y captura de datos con tecnología RFID diseñado para capturar información de forma automática, rápida y libre de errores, realizando la lectura de múltiples items en forma simultánea.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Desperdicio de recursos y tiempo en el control de inventarios.</p>
                  <p>Información imprecisa.</p>
                  <p>Pérdidas o robo de prendas.</p>

                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Las etiquetas RFID permitirán identificar y controlar las prendas textiles de forma automática y rápida.</p>
                  <p>Al recepcionar la mercadería en el centro de distribución pasa por un TUNEL RFID y se verifica automáticamente su contenido sin necesidad de abrir las cajas.</p>
                  <p>Se controla el despacho utilizando un túnel RFID.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Precisión en el inventario.</p>
                  <p>Reducción de quiebres de stock.</p>
                  <p>Mayor control de inventarios.</p>
                  <p>Ahorro de tiempos y costos.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/retail/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. ASOCIAR</h2>
                  <div class="member-pos theme_color">los tags RFID a los artículos.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/retail/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/retail/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. CONTROLA</h2>
                  <div class="member-pos theme_color">el despacho con túnel RFID.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/retail/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. EVITA</h2>
                  <div class="member-pos theme_color">perdidas y robos.</div>
                </div>
              </div>
            </div>
          </div>
