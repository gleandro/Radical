...
<head>
  ...
  <meta property="og:site_name" content="Control de Retornables">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_Activos/retornables">
  <meta property="og:title" content="Control de Retornables">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/control/retornable/control-retornable-imagen-superior.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h2>CONTROL DE RETORNABLES</h2>
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>ADMINISTRACION DE ACTIVOS DE FORMA EFICIENTE</strong>
              </h3>
              <p style="text-align: center;">El control de activos retornables basado en tecnología (RFID), es la forma más efectiva de monitorear el movimiento de las mismas dentro de la cadena de abastecimiento logístico que son utilizados.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>El no registro de entradas y salidas de stock.</p>
                  <p>Mala visibilidad del stock.</p>
                  <p>Problemas operativos por falta de herramientas de control de stock.</p>

                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Se identifica cada contenedor con un tipo de Tag RFID de acuerdo con el material necesario.</p>
                  <p>Instalación de Portales RDIF en puntos de ingreso/salida a controlar.</p>
                  <p>Al atravesar los puntos de control, los lectores RFID obtienen la información de los tags y es enviada a la aplicación.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Lectura de activos en tiempo real.</p>
                  <p>Reducción de costos y maximización de ingresos.</p>
                  <p>Reducción de errores humanos.</p>
                  <p>Rotación más rápida de activos retornables.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/control/retornable/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. CONTABILIZACIÓN</h2>
                  <div class="member-pos theme_color">precisa</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/control/retornable/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA </h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/control/retornable/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. ECONIMIZA</h2>
                  <div class="member-pos theme_color">gastos y maximiza ingresos.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/control/retornable/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. REDUCCIÓN</h2>
                  <div class="member-pos theme_color">de errores humanos.</div>
                </div>
              </div>
            </div>
          </div>
