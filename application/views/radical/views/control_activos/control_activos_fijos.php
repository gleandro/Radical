        ...
        <div class="container">
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <p style="text-align: center;">La utilización de tecnología RFID nos permite realizar el procedimiento de captura de los activos, de una forma más rápida y ágil, identificando y auditando los mismos en cuestión de minutos.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            ...
            <div class="cstheme_member_wrapper">
              ...
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. ASOCIA</h2>
                  <div class="member-pos theme_color">el activo con su código.</div>
                </div>
              </div>
            </div>
          </div>
