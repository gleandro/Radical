...
<head>
  ...
  <meta property="og:site_name" content="Control de Activos">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_Activos">
  <meta property="og:title" content="Control de Activos">
...
<div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/carousel/img2.jpg);">
  ...
  <div id="blog_list" class="default">
    <div class="row">
      <div class="isotope_container_wrap">
        <div class="isotope-container isotope" style="position: relative; overflow: hidden; height: 1160px;">
          <article id="post-2712" class="col-md-3 mb40 post-2712 post type-post status-publish format-image has-post-thumbnail hentry category-news tag-dress tag-fashion tag-style post_format-post-format-image isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px);">
            <div class="post-content-wrapper clearfix">
              <div class="featured_img_bg" style="background-image:url(<?php echo base_url(); ?>application/helpers/images/control/1.jpg);"></div>
              <div class="post_descr_wrap">
                <h2 class="post-title">
                 <a href="<?php echo base_url(); ?>Control_Activos/retornables" title="Control de retornables" rel="bookmark">Control de Retornables </a>
               </h2>
             </div>
           </div>
         </article>
         <article id="post-2712" class="col-md-3 mb40 post-2712 post type-post status-publish format-image has-post-thumbnail hentry category-news tag-dress tag-fashion tag-style post_format-post-format-image isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px);">
          <div class="post-content-wrapper clearfix">
            <div class="featured_img_bg" style="background-image:url(<?php echo base_url(); ?>application/helpers/images/control/2.jpg);"></div>
            <div class="post_descr_wrap">
              <h2 class="post-title">
               <a href="<?php echo base_url(); ?>Control_Activos/activos" title="Control de Activos Fijos" rel="bookmark">Control de Activos Fijos</a>
             </h2>
           </div>
         </div>
       </article>
       <article id="post-2712" class="col-md-3 mb40 post-2712 post type-post status-publish format-image has-post-thumbnail hentry category-news tag-dress tag-fashion tag-style post_format-post-format-image isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px);">
        <div class="post-content-wrapper clearfix">
          <div class="featured_img_bg" style="background-image:url(<?php echo base_url(); ?>application/helpers/images/control/3.jpg);"></div>
          <div class="post_descr_wrap">
            <h2 class="post-title">
             <a href="<?php echo base_url(); ?>Control_Activos/equipos" title="Control de Equipos TI" rel="bookmark">Control de Equipos TI</a>
           </h2>
         </div>
       </div>
     </article>
     <article id="post-2712" class="col-md-3 mb40 post-2712 post type-post status-publish format-image has-post-thumbnail hentry category-news tag-dress tag-fashion tag-style post_format-post-format-image isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px);">
      <div class="post-content-wrapper clearfix">
        <div class="featured_img_bg" style="background-image:url(<?php echo base_url(); ?>application/helpers/images/control/4.jpg);"></div>
        <div class="post_descr_wrap">
          <h2 class="post-title">
           <a href="<?php echo base_url(); ?>Control_Activos/neumaticos" title="Control de Neumáticos" rel="bookmark">Control de Neumáticos</a>
         </h2>
       </div>
     </div>
   </article>
   <article id="post-2712" class="col-md-3 mb40 post-2712 post type-post status-publish format-image has-post-thumbnail hentry category-news tag-dress tag-fashion tag-style post_format-post-format-image isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px);">
    <div class="post-content-wrapper clearfix">
      <div class="featured_img_bg" style="background-image:url(<?php echo base_url(); ?>application/helpers/images/control/5.jpg);"></div>
      <div class="post_descr_wrap">
        <h2 class="post-title">
         <a href="<?php echo base_url(); ?>Control_Activos/documental" title="Control Documental" rel="bookmark">Control Documental</a>
       </h2>
     </div>
   </div>
 </article>
