...
<head>
  ...
  <meta property="og:site_name" content="Control de Pagos">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_de_Pagos">
  <meta property="og:title" content="Control de Pagos">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/pagos/header.jpg);">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>TARJETA CARDBUREX - TECNOLOGÍA NFC</strong>
              </h3>
              <p style="text-align: center;">La tecnología de comunicación de corta distancia, conocida como NFC, promete jugar un rol importante en la manera en cómo utilizamos nuestros teléfonos o la tarjeta NFC cuando de pagos se trata, ya no necesitaras dinero en efectivo ni pagos a terceros.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Solo se recibe dinero en efectivo en la mayoría de servicios.</p>
                  <p>Demora en el manejo de dinero de los servicios.</p>
                  <p>Pagos a terceros por el uso de POS.</p>
                  <p>Inseguridad al cargar dinero en efectivo.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Implementación de plataforma CARDBUREX con NFC.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Control absoluto del usuario con el control de su efectivo visto desde su propio celular.</p>
                  <p>Supervisión y fácil manejo en el total del ingreso en los servicios.</p>
                  <p>Pago es posible de celular a celular.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="cstheme_member_wrapper">
              ...
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. ELIMINE</h2>
                  <div class="member-pos theme_color">comisiones cobradas por terceros.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              ...
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. AGILIZA</h2>
                  <div class="member-pos theme_color">el proceso de compra.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              ...
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. SUPRIME</h2>
                  <div class="member-pos theme_color">el uso de bancos como intermediarios.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              ...
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. EVITA</h2>
                  <div class="member-pos theme_color">clonaciones de tarjetas.</div>
                </div>
              </div>
            </div>
          </div>
