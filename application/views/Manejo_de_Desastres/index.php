...
<head>
  ...
  <meta property="og:site_name" content="Manejo de Desastres">
  <meta property="og:url" content="<?php echo base_url(); ?>Manejo_de_Desastres">
  <meta property="og:title" content="Manejo de Desastres">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
	...
	<div id="page-content" style="min-height: auto;">
	  <div id="error404_container" class="text-center" style="padding-top:15%;padding-bottom:15%">
		<div class="container">
		  <h2>Lo sentimos, usted no esta habilitado para esta opción.</h2>
		  <h2>"Manejo de Desastres"</h2>
		  <div class="clearfix">
		  </div>
		  <a class="btnback theme_color" href="<?php echo base_url();?>">Regresar</a>
		</div>
	  </div>
	</div>
    <footer>
