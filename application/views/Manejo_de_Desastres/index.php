...
<html>
  <head>
    <meta charset="utf-8">
      ...
      <title>Manejo de desastres</title>
  </head>
  <body>
    <header>
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          ...
          <div class="carousel-caption">
            <span class="top">ALERTA TEMPRANA</span><br>
            <span class="top">DE </span><span class="text_red top">DESASTRES</span><br>
          </div>
        </div>
      </div>
    </div>
    <div class="bloque">
      <div class="row titulo">
        <div class="col-md-12">
          <span class="">ALERTA DE DESASTRES</span>
        </div>
      </div>
      <div class="row detalle">
        <div class="col-md-12">
          <span>Aplicación móvil para alerta temprana de desastres naturales.</span>
        </div>
      </div>
    </div>
      ...
      <div class="row ">
        <div class="col-md-4 black center">
          ...
          <div class="row">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Falta de comunicación en la coordinación de los desastres.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Redes de líneas telefónicas congestionadas.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Demora en la comunicación.</span>
            </div>
          </div>
        ...
        <div class="col-md-4 red center">
          ...
          <div class="row">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Implementación de la plataforma AHLERTA para facilitar la comunicación en los desastres.</span>
            </div>
          </div>
        ...
        <div class="col-md-4 black center">
          ...
          <div class="row">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Comunicación eficaz en las emergencias.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Noticias a tiempo real sobre los desastres.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-9 col-sm-9 left">
              <span class="text_white_detalle">Localización a tiempo real del desastre.</span>
            </div>
          </div>
    ...
    <div class="fichero">
      ...
      <div class="tercero" style="left: 52%;">
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            emergencias de manera inmediata.
          </div>
        </div>
      </div>
