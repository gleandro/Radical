...
<head>
  ...
  <meta property="og:site_name" content="Salud y Trazabilidad">
  <meta property="og:url" content="<?php echo base_url(); ?>Salud_y_Trazabilidad">
  <meta property="og:title" content="Salud y Trazabilidad">
        ...
        <div class="isotope-container isotope" style="position: relative; overflow: hidden; height: 1160px;">
          <article id="post-2712" class="col-md-3 mb40 post-2712 post type-post status-publish format-image has-post-thumbnail hentry category-news tag-dress tag-fashion tag-style post_format-post-format-image isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px);">
            <div class="post-content-wrapper clearfix">
              <div class="featured_img_bg" style="background-image:url(<?php echo base_url(); ?>application/helpers/images/salud/1.jpg");"></div>
              <div class="post_descr_wrap">
                <h2 class="post-title">
                <a href="<?php echo base_url(); ?>Salud_y_Trazabilidad/medicamentos" title="Control de retornables" rel="bookmark">Trazabilidad de Medicamentos</a>
               </h2>
             </div>
           </div>
         </article>
         <article id="post-2712" class="col-md-3 mb40 post-2712 post type-post status-publish format-image has-post-thumbnail hentry category-news tag-dress tag-fashion tag-style post_format-post-format-image isotope-item" style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px);">
          <div class="post-content-wrapper clearfix">
            <div class="featured_img_bg" style="background-image:url(<?php echo base_url(); ?>application/helpers/images/salud/2.jpg");"></div>
            <div class="post_descr_wrap">
              <h2 class="post-title">
               <a href="<?php echo base_url(); ?>Salud_y_Trazabilidad/seguimiento" title="Control Documental" rel="bookmark">Seguimiento de pacientes y personal médico</a>
             </h2>
           </div>
         </div>
       </article>
