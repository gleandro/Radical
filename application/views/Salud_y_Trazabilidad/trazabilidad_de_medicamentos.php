  ...
  <body>
    ...
    <div class="bloque" id="soluciones">
      <div class="row titulo">
        <div class="col-md-12">
          <span class="">TRAZABILIDAD DE MEDICAMENTOS Y PRODUCTOS MÉDICOS</span>
        </div>
      </div>
    ...
    <div class="fichero">
      <img class="fondotop" src="<?php echo base_url(); ?>/application/helpers/images/salud/medicamentos/superior.png" alt="" id="top" style="opacity:0">
      <img class="fondobot" align="right" src="<?php echo base_url(); ?>/application/helpers/images/salud/medicamentos/inferior.png" alt="" id="bot" style="opacity:0">
      <div class="primero" id="num_1" style="display:none">
        <div class="row text_red_bold">
          ...
          <div class="col-md-10">
            ASOCIAR
            <span style="color:#333; font-weight:normal;font-size:14px;"> tags rfid a </span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
