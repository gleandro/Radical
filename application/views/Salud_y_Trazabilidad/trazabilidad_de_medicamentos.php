        ...
        <div class="container">
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <p style="text-align: center;">Nuestra solución comprende un sistema de identificación y captura de datos con tecnología RFID diseñado para capturar información de forma automática y a alta velocidad, realizando la lectura de todos los items de forma simultanea.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
