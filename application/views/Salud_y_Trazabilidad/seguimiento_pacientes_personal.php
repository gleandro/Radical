...
<html>
  <head>
    <meta charset="utf-8">
      ...
      <title>Seguimiento de pacientes y personal médico</title>
  </head>
  <body>
    <header>
    ...
    <div class="bloque" id="soluciones">
      <div class="row titulo">
        <div class="col-md-12">
          <span class="">TRAZABILIDAD DE PACIENTES</span>
        </div>
      </div>
      <div class="row detalle">
        <div class="col-md-12">
          <span>Nuestra solución comprende un sistema de Identificación y captura de datos con</span><br>
          <span>tecnología RFID para el monitoreo de los pacientes y personal médico, logrando una</span><br>
          <span>eficiente atención en los servicios de salud y alcanzar la certificación de servicios de</span><br>
          <span>salud de clase mundial.</span>
        </div>
      </div>
    </div>
    ...
    <div class="fichero">
      <img class="fondotop" src="<?php echo base_url(); ?>/application/helpers/images/salud/pacientes/superior.png" alt="" id="top" style="opacity:0">
      <img class="fondobot" align="right" src="<?php echo base_url(); ?>/application/helpers/images/salud/pacientes/inferior.png" alt="" id="bot" style="opacity:0">
      <div class="primero" id="num_1" style="display:none">
        <div class="row text_red_bold">
          ...
          <div class="col-md-10">
            ASOCIA
            <span style="color:#333; font-weight:normal;font-size:14px;"> cada paciente </span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
      ...
      <div class="tercero" id="num_3" style="display:none">
        <div class="row text_red_bold">
          ...
          <div class="col-md-10">
            REDUCE
            <span style="color:#333; font-weight:normal;font-size:14px;"> tiempo y </span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
          ...
          <div class="col-md-9">
            costos en el seguimineto de pacientes.
          </div>
        </div>
      </div>
      <div class="cuarto" id="num_4" style="display:none">
        <div class="row" style="margin-left: 20%;">
          <img class="imagen" src="<?php echo base_url(); ?>/application/helpers/iconos/salud/icono.png" alt="">
        </div>
        <div class="row text_red_bold">
          <div class="col-xs-1 col-sm-1 col-md-1">
            4.
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            manera eficaz en el dosaje de medicamentos.
          </div>
        </div>
      </div>
    </div>
