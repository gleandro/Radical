            ...
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  ...
                  <p>Falta de control en la distribución en la dosis de medicametos.</p>
                  <p>Elimina el riesgo de cambio de recién nacidos por confusión o error humano.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Cada paciente debe ser identificado con etiquetas RFID las cuales identificarán y controlarán la ubicacion del paciente y la dosis de medicamentos.</p>
                ...
                <div class="tab-pane" style="display: none;">
                  ...
                  <p>Emite alarma si el paciente y/o personal cruza el perimetro permitido.</p>
                  <p>Reducción de tiempos y costos de control en la entregade dosis a pacientes.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              ...
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. REDUCE</h2>
                  <div class="member-pos theme_color">tiempo y costos en el seguimineto de pacientes.</div>
                </div>
              </div>
            </div>
          </div>
