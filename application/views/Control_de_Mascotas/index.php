...
<head>
  ...
  <meta property="og:site_name" content="Control de Mascotas">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_de_Mascotas">
  <meta property="og:title" content="Control de Mascotas">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/carousel/img7.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h2>CONTROL DE MASCOTAS</h2>
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>SOLUCIÓN AL CONTROL DE MASCOTAS</strong>
              </h3>
              <p style="text-align: center;">Nuestra solución comprende un sistema de identificación hacia las mascotas para su rapida localización y asi evitar perdidas.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Perdida de mascotas a diario.</p>
                  <p>Mascotas extraviadas sin información del dueño.</p>
                  <p>Desconocimiento de antecedentes de la mascota en caso de encontrar una.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Asociar la mascota con su tag RFID.</p>
                  <p>Brindar al sistema información completa sobre la mascota.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Alerta en tiempo real al leerse el tag de la mascota, haciendo fácil su localización.</p>
                  <p>Brinda documentación de la mascota, como el certificado virtual de nacimiento.</p>
                  <p>Red social de mascotas, incluido en el sistema, para la interacción entre mascotas.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/mascotas/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. CERTIFICADO VIRTUAL DE NACIMIENTO</h2>
                  <div class="member-pos theme_color">para tu mascota.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/mascotas/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. RED SOCIAL DE MASCOTAS</h2>
                  <div class="member-pos theme_color">para encontrar amigos.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/mascotas/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. REGISTRA</h2>
                  <div class="member-pos theme_color">a tu mascota en nuestra aplicación móvil.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/mascotas/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. RECIBE NOTIFICACIONES</h2>
                  <div class="member-pos theme_color">cuando alguien encuentre a tu mascota.</div>
                </div>
              </div>
            </div>
          </div>
