  ...
  <body>
    ...
    <div class="bloque" id="soluciones">
      <div class="row titulo">
        <div class="col-md-12">
          <span class="">SOLUCIÓN AL CONTROL DE MASCOTAS</span>
        </div>
      </div>
    ...
    <div class="fichero">
      <img class="fondotop" src="<?php echo base_url(); ?>/application/helpers/images/mascotas/superior.png" alt="" id="top" style="opacity:0">
      <img class="fondobot" align="right" src="<?php echo base_url(); ?>/application/helpers/images/mascotas/inferior.png" alt="" id="bot" style="opacity:0">
