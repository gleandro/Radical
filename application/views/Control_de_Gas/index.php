...
<head>
  ...
  <meta property="og:site_name" content="Control de Cilindros de Gas">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_de_Gas">
  <meta property="og:title" content="Control de Cilindros de Gas">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/carousel/img6.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h2>CONTROL DE CILINDROS DE GAS</h2>
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>SOLUCIÓN A CILINDRO DE GAS</strong>
              </h3>
              <p style="text-align: center;">Proporciona un seguimiento automatizado de activos para cilindros de gas. La solución atiende a la capacidad de rastrear cilindros con mayor precisión y conocer el estado del activo.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Robo de cilindros.</p>
                  <p>El uso indebido de los cilindros.</p>
                  <p>Circulación de cilindros en mal estado que pone en riesgo a la seguridad.</p>
                  <p>Pérdida en la contabilización manual de los cilindros.</p>

                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Sistema que permite asosicar todos los cilindros para su rapido conteo.</p>
                  <p>Tags RFID proporcionan un reporte del estado de los cilindros (tiempo de vida y peso).</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Reducción del índice de robos de cilindros.</p>
                  <p>Da una contabilización automática y exacta de los cilindros.</p>
                  <p>Ayuda a prevenir accidentes por el desgaste del cilindro.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/gas/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. ASOCIA</h2>
                  <div class="member-pos theme_color">cada cilindro con su Tag RFID.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/gas/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/gas/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. REDUCCIÓN</h2>
                  <div class="member-pos theme_color">de tiempo y costos en inventario.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/gas/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. REDUCE</h2>
                  <div class="member-pos theme_color">la tasa de accidentes por el mal estado del cilindro.</div>
                </div>
              </div>
            </div>
          </div>
