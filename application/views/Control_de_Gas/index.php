  ...
  <body>
    ...
    <div class="bloque" id="soluciones">
      ...
      <div class="row detalle">
        <div class="col-md-12">
          <span>Proporciona un seguimiento automatizado de activos para cilindros de gas.</span><br>
          <span>La solución atiende a la capacidad de rastrear cilindros con mayor precisión</span><br>
          <span>y conocer el estado del activo.</span>
        </div>
      </div>
    </div>
      ...
      <div class="row ">
        <div class="col-md-4 black center" id="a" style="min-height: 540px;display:none">
          ...
          <div class="row">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Circulación de cilindros en mal estado que pone en riesgo a la seguridad.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Pérdida en la contabilización manual de los cilindros.</span>
            </div>
          </div>
        </div>
        <div class="col-md-4 red center" id="b" style="min-height: 540px;display:none">
          ...
          <div class="row">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Sistema que permite asosicar todos los cilindros para su rapido conteo.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Tags RFID proporcionan un reporte del estado de los cilindros (tiempo de vida y peso).</span>
            </div>
          </div>
        </div>
        <div class="col-md-4 black center" id="c" style="min-height: 540px;display:none">
          ...
          <div class="row">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Reducción del índice de robos de cilindros.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
            ...
            <div class="col-xs-10 col-sm-10 col-md-10  left">
              <span class="text_white_detalle">Da una contabilización automática y exacta de los cilindros.</span>
            </div>
          </div>
          <div class="row">
            <div class="col-xs-1 col-sm-1 col-md-1">
    ...
    <div class="fichero">
      ...
      <div class="cuarto" id="num_4" style="top: 65%;left: 65%;display:none">
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            de accidentes por el mal estado del cilindro.
          </div>
        </div>
      </div>
