...
<head>
  ...
  <meta property="og:site_name" content="Control de Peaje">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_de_Peaje">
  <meta property="og:title" content="Control de Peaje">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/peaje/peaje.jpg);">
      <div class="pagetitle_content">
        <div class="pagetitle_content_wrap clearfix">
          <h2>CONTROL DE PEAJE</h2>
      ...
      <div id="blog_list" class="default">
        <div class="container">
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <p style="text-align: center;">El sistema de peaje utiliza la tecnología RFID para realizar la identificación automática de un vehículo y autorizar su circulación sin necesidad de detenerse.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>Excesivo tráfico en autopistas.</p>
                  <p>Pérdida de tiempo en el pago del peaje.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Implementacion del sistema Free Flow que permite al usuario pagar sin parar.</p>
                  <p>Autorización y conteo automático de un vehiculo.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Auditorias de activos más rápidas.</p>
                  <p>Mejora la circulación de vehículos.</p>
                  <p>Reduce costos al concesionario de la autopista.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/peaje/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. IMPLEMENTACIÓN</h2>
                  <div class="member-pos theme_color">del sistema Free Flow.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/peaje/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/peaje/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. REDUCE</h2>
                  <div class="member-pos theme_color">costos al concesionario de la autopista.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;" >
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url(); ?>application/helpers/images/peaje/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. MEJORA</h2>
                  <div class="member-pos theme_color">la circulación vehicular.</div>
                </div>
              </div>
            </div>
          </div>
