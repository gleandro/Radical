...
<head>
  ...
  <meta property="og:site_name" content="Control de Acceso">
  <meta property="og:url" content="<?php echo base_url(); ?>Control_de_Acceso">
...
<body class="blog pagetitle_show portfolio_slider_ footer_">
  <div id="page-wrap">
    ...
    <div id="pagetitle" class=" breadcrumbs_hide text-center" style="background-position: 15%;margin-top: -122px; padding-top: 122px;background-image: url(<?php echo base_url(); ?>application/helpers/images/acceso/header.jpg);">
      ...
      <div id="blog_list" class="default">
          ...
          <div class="row">
            <div class="cs-element  col-md-12" style="margin-bottom:20px;">
              ...
              <h3 style="text-align: center;">
                <strong>SOLUCIÓN RFID + CCTV</strong>
              </h3>
              <p style="text-align: center;">Al integrar los datos de identificación RFID con CCTV, se tiene un control de acceso mas preciso ya que puede investigar y prevenir entradas o salidas no deseadas, seguir y gestionar el personal que ingresa de manera más eficaz y obtener una visión sin precedentes en su empresa.</p>
              <p style="text-align: center;">&nbsp;</p>
            </div>
          </div>
          <div class="row">
            <div class="cs-element cstheme-tab tabbable tabs-top col-md-12" style="margin-bottom:60px;">
              ...
              <div class="tab-content">
                <div class="tab-pane active">
                  <p>No se posee un control total ni a tiempo real por lo que genera entradas y salidas no deseadas y puede causar pérdidas importantes a la empresa.</p>
                  <p>Falta de supervisión exacta en las cámaras debido al monitoreo que tiene que hacer el personal durante horas.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Integración con RFID + CCTV para el monitoreo del control de acceso.</p>
                </div>
                <div class="tab-pane" style="display: none;">
                  <p>Localiza con precisión el ingreso y salida de todos los tags RFID en tiempo real.</p>
                  <p>Se integra con las cámaras para proporcionar automáticamente un clip de vídeo cada vez que se mueve un activo.</p>
                  <p>A través de la cámara la plataforma genera el minuto exacto donde se movió el activo con RFID, sin la necesidad de ver extensas horas de video.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row" style="text-align: center;">
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/acceso/1.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>1. Integre</h2>
                  <div class="member-pos theme_color">RFID + CCTV.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/acceso/2.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>2. LECTURA</h2>
          ...
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/acceso/3.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>3. REPORTA</h2>
                  <div class="member-pos theme_color">movimientos de manera inmediata.</div>
                </div>
              </div>
            </div>
          </div>
          <div class="cs-element cstheme-team col-md-3" style="margin-bottom:60px;">
            <div class="cstheme_member_wrapper">
              <div class="member-image">
                <img src="<?php echo base_url();?>application/helpers/images/acceso/4.png" alt="Anna Balashova">
              </div>
              <div class="cstheme_member_descr">
                <div class="member-title" style ="width:100%">
                  <h2>4. MONITOREA</h2>
                  <div class="member-pos theme_color">cada tag junto con la cámara para saber sus movimientos incluso en determinadas horas.</div>
                </div>
              </div>
            </div>
          </div>
