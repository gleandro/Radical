...
<html>
  ...
  <body>
    ...
    <div class="cuerpodetalle" id="bloques" >
      <div class="row ">
        <div class="col-sm-12 col-md-12 col-lg-4 black center" id="a" style="min-height: 550px;display:none">
          <div class="">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 red center" id="b" style="min-height: 550px;display:none">
          <div class="">
        ...
        <div class="col-sm-12 col-md-12 col-lg-4 black center" id="c" style="min-height: 550px;display:none">
          <div class="">
    ...
    <div class="fichero">
      <img class="fondotop" src="<?php echo base_url(); ?>/application/helpers/images/acceso/up.png" alt="" id="top" style="opacity:0">
      <img class="fondobot" align="right" src="<?php echo base_url(); ?>/application/helpers/images/acceso/down.png" alt="" id="bot" style="opacity:0">
