...
<html>
  <head>
    <meta charset="utf-8">
      ...
      <title>Bloqueo de celulares en las carceles</title>
  </head>
  <body>
    <header>
    ...
    <div class="bloque">
      ...
      <div class="row detalle">
        <div class="col-md-12">
          <span>Nuestra solución comprende un sistema de Identificación y bloqueo de señal de</span><br>
          <span>celular dentro de las cárceles para evitar el mal uso de estos.</span>
        </div>
      </div>
    </div>
    ...
    <div class="fichero">
      ...
      <div class="primero">
        <div class="row text_orange_bold">
          ...
          <div class="col-md-10">
            IMPLEMENTA
            <span style="color:#333; font-weight:normal;font-size:14px;"> la antena</span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
      ...
      <div class="tercero" style="left: 52%;">
        <div class="row text_orange_bold">
          ...
          <div class="col-md-9">
            lIMITE
            <span style="color:#333; font-weight:normal;font-size:14px;"> el uso de</span>
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1 col-sm-1 col-md-1">
